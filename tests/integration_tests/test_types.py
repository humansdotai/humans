...
def test_block(humans, geth):
    get_blocks(humans, geth, False)
    get_blocks(humans, geth, True)


def get_blocks(humans_rpc_ws, geth, with_transactions):
    ...
    humans_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [humans_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_syncing(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(humans_rpc_ws, geth):
    # on humans the proof query will fail for block numbers <= 2
...
def test_get_code(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(humans_rpc_ws, geth):
    w3: Web3 = humans_rpc_ws.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(humans_rpc_ws, geth):
...
def test_incomplete_send_transaction(humans_rpc_ws, geth):
