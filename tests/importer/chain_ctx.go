...
// transactions. There should only be a single implementation in Humans. For
// the purposes of Humans, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Humans will distribute the fees out to validators, so the structure
