...
// source: humans/superadmin.proto
...
func (*Superadmin) Descriptor() ([]byte, []int) {
	return fileDescriptor_38f4a3cbed1dd217, []int{0}
}
...
func (m *Superadmin) GetIndex() string {
	if m != nil {
		return m.Index
	}
	return ""
...
func init() {
	proto.RegisterType((*Superadmin)(nil), "humansdotai.humans.humans.Superadmin")
}

func init() { proto.RegisterFile("humans/superadmin.proto", fileDescriptor_38f4a3cbed1dd217) }

var fileDescriptor_38f4a3cbed1dd217 = []byte{
	// 162 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xcf, 0x28, 0xcd, 0x4d,
	0xcc, 0x2b, 0xd6, 0x2f, 0x2e, 0x2d, 0x48, 0x2d, 0x4a, 0x4c, 0xc9, 0xcd, 0xcc, 0xd3, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0x92, 0x84, 0x48, 0xa4, 0xe4, 0x97, 0x24, 0x66, 0xea, 0x41, 0xd8, 0x50,
	0x4a, 0xc9, 0x86, 0x8b, 0x2b, 0x18, 0xae, 0x5c, 0x48, 0x84, 0x8b, 0x35, 0x33, 0x2f, 0x25, 0xb5,
	0x42, 0x82, 0x51, 0x81, 0x51, 0x83, 0x33, 0x08, 0xc2, 0x11, 0x92, 0xe0, 0x62, 0x4f, 0x4c, 0x49,
	0x29, 0x4a, 0x2d, 0x2e, 0x96, 0x60, 0x02, 0x8b, 0xc3, 0xb8, 0x4e, 0x6e, 0x27, 0x1e, 0xc9, 0x31,
	...
	0x9f, 0xab, 0x8f, 0x64, 0x3b, 0x94, 0xad, 0x5f, 0x01, 0x63, 0x94, 0x54, 0x16, 0xa4, 0x16, 0x27,
	0xb1, 0x81, 0xdd, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xa5, 0xef, 0x9f, 0x1b, 0xc2, 0x00,
	0x00, 0x00,
}
...
func (m *Superadmin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Index) > 0 {
		i -= len(m.Index)
		copy(dAtA[i:], m.Index)
		i = encodeVarintSuperadmin(dAtA, i, uint64(len(m.Index)))
		i--
		dAtA[i] = 0xa
	}
