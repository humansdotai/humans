...
The `x/evm` is part of the [humans library](https://pkg.go.dev/github.com/0x4139/humans). For an example of how Humans can be used on any Cosmos-SDK chain, please refer to [Evmos](https://www.github.com/tharsis/evmos).
